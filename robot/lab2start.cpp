...
GLfloat angle_x, armangle, angle_x_inc, anglex;
...
void display()
{
	...
	//model.top() = glm::translate(model.top(), glm::vec3(x2, y2, 0));
	//model.top() = glm::scale(model.top(), glm::vec3(scale, scale, scale));
	//model.top() = glm::rotate(model.top(), -angle_x, glm::vec3(1, 0, 0)); //rotating in clockwise direction around x-axis
	//model.top() = glm::rotate(model.top(), -angle_z, glm::vec3(0, 0, 1)); //rotating in clockwise direction around x-axis
	...
	//if (anglex >= 30.0f && anglex <= 90.0f)
	//{
	//	std::cout << "hi";
	//	View = glm::lookAt(
	//		glm::vec3(0, 0, 1), // Camera is at (0,0,4), in World Space
	//		glm::vec3(0, 0, 0), // and looks at the origin
	//	glm::vec3(0, 1, 0)  // Head is up (set to 0,-1,0 to look upside-down)
	//		);
	//}
	...
	//	std::cout << "hi";
	//	View = glm::lookAt(
	//		glm::vec3(0.2, 0, 1), // Camera is at (0,0,4), in World Space
	//		glm::vec3(0, 0, 0), // and looks at the origin
	//		glm::vec3(0, 1, 0)  // Head is up (set to 0,-1,0 to look upside-down)
	//		);
	//}
