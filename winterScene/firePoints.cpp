...
void firePoints::updateParams(GLfloat dist, GLfloat sp)
{
	maxdist = dist;
	speed = sp;
}
...
void firePoints::drawBranch(int rotate, int color, GLuint texID, GLuint transID, GLuint colorID)
{
